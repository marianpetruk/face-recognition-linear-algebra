import numpy as np
from tinyfacerec.util import asRowMatrix
from tinyfacerec.subspace import pca, lda, fisherfaces, project
from tinyfacerec.distance import EuclideanDistance
